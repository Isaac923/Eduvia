...
// SweetAlert2 para confirmación de modificar asistencia - VERSIÓN CORREGIDA
document.addEventListener('DOMContentLoaded', function() {
    ...
    botonesModificar.forEach(function(boton) {
        boton.addEventListener('click', function(e) {
            ...
            // SOLUCIÓN: Usar async/await y manejar mejor el cierre
            (async () => {
                try {
                    const result = await Swal.fire({
                        ...
                        // NUEVO: Configuraciones adicionales para forzar el cierre
                        backdrop: true,
                        heightAuto: false,
                        scrollbarPadding: false
                    });
                    
                    // SOLUCIÓN: Verificar explícitamente si se confirmó
                    if (result.isConfirmed) {
                        ...
                        // SOLUCIÓN: Forzar cierre si se cancela
                        Swal.close();
                    }
                } catch (error) {
                    // SOLUCIÓN: En caso de error, forzar cierre
...
// SOLUCIÓN ADICIONAL: Función para forzar cierre de todos los modales
...
// SOLUCIÓN: Agregar listener para ESC como backup
