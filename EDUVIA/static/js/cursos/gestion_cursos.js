  document.addEventListener('DOMContentLoaded', function() {
      ...
      // Obtener URLs de los atributos de datos
      const urls = {
          detalles: container.dataset.detallesUrl,
          alumnosDetalles: container.dataset.alumnosDetallesUrl,
          editarCurso: container.dataset.editarCursoUrl,
          eliminarCurso: container.dataset.eliminarCursoUrl,
          editarAlumno: container.dataset.editarAlumnoUrl,
          eliminarAlumno: container.dataset.eliminarAlumnoUrl
      };
