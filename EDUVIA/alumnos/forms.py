...
class AlumnoCreationForm(forms.ModelForm):
    ...
    # Asegúrate de que estos campos estén en el formulario:
    ...
    class Meta:
        ...
        # Asegurar que observaciones y diagnostico NO estén excluidos
    ...
    def __init__(self, *args, **kwargs):
        ...
        required_fields = [
            'fecha_ingreso', 'primer_nombre', 'apellido_paterno', 'apellido_materno',
            'rut', 'fecha_nacimiento', 'sexo', 'direccion', 'telefono',
            'numero_nivel', 'letra_nivel', 'estado_civil', 'religion',
            'programa_pie', 'informe_psicosocial', 'situacion_laboral', 'diagnostico'
        ]
        
        for field_name in required_fields:
            if field_name in self.fields:
                self.fields[field_name].required = True
                # Agregar clase CSS para Bootstrap
        ...
        # Quitar la opción vacía del select de diagnóstico
        if 'diagnostico' in self.fields:
            self.fields['diagnostico'].empty_label = None
