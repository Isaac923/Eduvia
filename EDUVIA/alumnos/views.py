...
def crear_ano_academico(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            # Si hay alumnos en el año activo actual, transferirlos como inactivos al nuevo año
            if ano_activo_actual:
                alumnos_activos = AlumnoAno.objects.filter(
                    ano_academico=ano_activo_actual,
                    activo=True
                )
                
                alumnos_transferidos = 0
                for alumno_ano in alumnos_activos:
                ...
                messages.success(
                    ...
                    f'{alumnos_transferidos} alumnos han sido transferidos al nuevo año (inactivos). '
